...
/**
 * 订单控制器 @Author: 梁歪歪 <1732178815@qq.com> @Description: blog <liangyy.cn> @Create 2021-05-13-12:30
 */
@CrossOrigin(
...
public class OrderController extends BaseController {
  ...
  public CommonReturnType generateToken(
    ...
    String redisVerifyCode =
        (String) redisTemplate.opsForValue().get("verify_code_" + userModel.getId());
        ...
        executorService.submit(
            new Callable<Object>() {
              ...
              public Object call() throws Exception {
                ...
                // 再去完成对应的下单事物型消息
                boolean result =
                    mqProducer.transactionAsyncReduceStock(
                        userModel.getId(), promoId, itemId, amount, stockLogId);
                if (!result) {
